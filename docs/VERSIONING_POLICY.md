...
project: regmonkey-mathcamp-by-julia
---

# Versioning Policy

- `regmonkey-mathcamp-by-julia` のバージョン管理は [Semantic Versioning](https://semver.org/)に基づいています
...
`regmonkey-mathcamp-by-julia` では、非推奨化 (deprecation) のプロセスを以下の方針で実施します。
